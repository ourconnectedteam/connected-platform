...
export const messaging = {
    ...
    async startConversation(currentUserId, otherUserId) {
        ...
        logger.debug('[DEBUG] Creating conversation with creator_id:', currentUserId);
        logger.debug('[DEBUG] Target user ID:', otherUserId);
        ...
        logger.debug('✅ Conversation created successfully:', conv);
